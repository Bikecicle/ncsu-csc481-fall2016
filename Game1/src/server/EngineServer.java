...
public class EngineServer {
	...
	private void initializeWorld() {
		...
		world.addGameObject(new DeathZone("dz1", -5, 50, 10, 300));
		world.addGameObject(new DeathZone("dz2", 105, 50, 10, 300));
		world.addGameObject(new DeathZone("dz3", 50, -5, 100, 10));
		world.addGameObject(new DeathZone("dz4", 50, 200, 100, 5));
