...
public class Projectile extends GameObject {
	...
	public Projectile(String name, double x, double y, double width, double height) {
		super(name);
		this.x = x;
		this.y = y;
		this.width = width;
	...
	public List<Component> build(EventManager eventManager) {
		...
		ColoredRectangleComponent renderShape = new ColoredRectangleComponent(guid, eventManager, position, width,
				height);
		CustomDriverComponent driver = new CustomDriverComponent(guid, eventManager, "projectile_motion.js", x, y);
